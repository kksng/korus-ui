describe('Wizard tests', () => {
  ...
  describe('Display', () => {
    ...
    it('Current step should have classes "active" and "progress"', () => cy
      .get('.wizard .step')
      .eq(2)
    ...
    it('Last step should have class "last"', () => cy
      .get('.wizard .step')
      .last()
  ...
  describe('Interaction', () => {
    it('Should switch to next step', () => cy
      .get('button.next')
      .click()
      .get('.wizard .step')
      .eq(3)
    ...
    it('Should switch to previous step', () => cy
      .get('button.previous')
      .click()
      .get('.wizard .step')
      .eq(1)
