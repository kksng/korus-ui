  ...
  <L.Div _article>
    ...
    <L.Section _block>
      ...
      <L.Div _block>
        <pre>
          {`
            L.form('formName').get() // => FormGetField[]
            L.form('formName', 'fieldName').get() // => FormGetField
            L.form('formName', ['fieldName1', 'fieldName2']).get() // => FormGetField[]
          `}
        </pre>
      </L.Div>
      ...
      <L.Div _block>
        <pre>
          {`
            ...
            // The interface is available as L.ValidationTypes.FormGetField
          `}
        </pre>
      </L.Div>
    </L.Section>
