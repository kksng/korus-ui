      ...
      <L.Ul _block _txt-list>
        ...
        <L.Li>
          <L.P>
            ...
            {' '}
            из объектов Date. Значение будет только в том случае, если текст поля ввода может быть преобразован в валидные дату и время (с учётом формата). В остальных случаях придёт <i>null</i>.
          </L.P>
          <L.P>
