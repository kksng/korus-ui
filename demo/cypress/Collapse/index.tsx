    ...
    <L.Div _demoStory>
      <L.Div _collapse__main>
        ...
        <L.Collapse 
          ...
          onSelect={
            (event) => setActiveKey1(event.component.value)
          }>
          ...
          <L.Collapse.Panel panelKey="2" isDisabled={false} wrapperRender={({ elementProps }) => <L.Div {...elementProps} />}>
            <L.Collapse.Heading>
      ...
      <L.Div _collapse__accordion>
        ...
        <L.Collapse 
          ...
          onSelect={
            (event) => setActiveKey2(event.component.value)
          }>
          <L.Collapse.Panel panelKey="1" wrapperRender={({ elementProps }) => <L.Div {...elementProps} />}>
            <L.Collapse.Heading>
          ...
          <L.Collapse.Panel panelKey="2" wrapperRender={({ elementProps }) => <L.Div {...elementProps} />}>
            <L.Collapse.Heading>
      ...
      <L.Div _collapse__disabled>
        <L.H4 _title>Collapse Disabled</L.H4>
        <br />
        <L.Collapse isAccordion={false} activePanelKey={activeKey3} onSelect={(event) => setActiveKey3(event.component.value)}>
          <L.Collapse.Panel panelKey="1" wrapperRender={({ elementProps }) => <L.Div {...elementProps} />}>
            <L.Collapse.Heading>
          ...
          <L.Collapse.Panel panelKey="2" isDisabled={true} wrapperRender={({ elementProps }) => <L.Div {...elementProps} />}>
            <L.Collapse.Heading>
